    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                GlowingView(color: Color(red: 0.94, green: 0.19, blue: 0.91))
                    ...
                    VStack(spacing: 0) {
                        RoundedRectangle(cornerRadius: 19.32368)
                            ...
                            .overlay(
                                HStack {
                                    Spacer()
                                    NavigationLink(destination: Guided4Screen().navigationBarBackButtonHidden(true)) {
                                        Text("繼續")
                                            .font(Font.custom("Inter", size: 16).weight(.semibold))
...
struct Guided3Screen_Previews: PreviewProvider {
